"""
Main Controller - MVC Architecture
...
class MainController:
    """Controller chính quản lý toàn bộ luồng ứng dụng
    ...
    - Thống kê: user_stats, recent_games, win_streak
    
    Quản lý:
    - self.user: Người dùng hiện tại
    ...
    def __init__(self):
        ...
        - auth_controller: AuthController() (xử lý xác thực)
        """
        self.user = None
    ...
    def login(self, username, password):
        ...
        3. Nếu thành công: Lưu self.user và kết nối lobby
        4. Trả về kết quả
        """
    ...
    def register(self, username, password):
        ...
        Đơn giản gọi AuthController.register()
    ...
    def logout(self):
        ...
        Luồng:
        1. Set trạng thái user offline trong DB
        2. Ngắt kết nối lobby_client
        3. Xóa tất cả session data (user, lobby_client, room, room_client)
        ...
        if self.user:
            from models.user_model import UserModel
            UserModel.set_online_status(self.user['id'], False)
